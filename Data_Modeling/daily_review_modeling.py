...
dic = {'1땅':'우땅','2땅':'우땅','3땅':'좌땅','유땅':'좌땅','투땅':'중땅','1비':'우플','2비':'우플','3비':'좌플','유비':'좌플','투비':'중땅',
       ...
       '포비':'중땅','포파':'중땅','투희번':'중땅','좌비/ 중비':'중플','투실':'중땅','유실':'좌땅','투안':'중안','3직':'좌플','3희번':'좌땅','투직':'중플',
       ...
       '투희선':'중땅','좌실':'좌플','투희실':'중땅','야선':'','우안/ 중안':'우안','좌안/ 유땅':'좌안'}
...
#### 한 이닝에 2타석 들어선 경우 -> 중2/ 유땅 이런식으로 나옴 -> 재가공 필요(앞에꺼만 추출)
